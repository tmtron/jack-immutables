# jack-immutables
Testing the android jack compiler with [Immutables](http://immutables.github.io/)
...
The project uses the [Android Jack compiler](https://source.android.com/source/jack.html) together with some annotation-processing.

There are 3 branches:
 * `android-annotations`: uses only [Android Annotations](http://androidannotations.org/)
 ...
 * `generatedCode`: uses only Android-Annotations - but also contains the file `ImmutableSimpleData` which was generated by immutables.org
  ...
  * use `Run` - `Make Project` fails with the error shown below
    ...
    * this issue has been reported to the immutables project: [#467](https://github.com/immutables/immutables/issues/467)
